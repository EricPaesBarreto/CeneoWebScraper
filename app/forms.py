...
class ProductIdForm(Form):
    product_id = StringField("product_id", name="product_id", validators=[
        validators.DataRequired(message='Product id is required'),
        validators.Length(min=6, max=10, message="Product id should be between 6 and 10 characters (inclusive)"),
